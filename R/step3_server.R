...
#simply ignore noPres (simple solution for now)
    ...
    obsConfirm <- shiny::observeEvent(input$confirmButton3, {
      ...
      r3$confirm <- input$confirmButton3
      #cleanup
      obsPrWeights$destroy()
      obsRWeights$destroy()
      obsReset$destroy()
      ...
      # shinyjs::reset("confirmButton3")
      # return(list(SM = reactive(SM), toSelectSpAfter = reactive(toSelectSpAfter), confirm = reactive({input$confirmButton3})) )
