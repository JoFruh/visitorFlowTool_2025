...
# Define server logic
step5_server <- function(id, network, minThresh, naturalAreas, confirm, i18n, currentLang, skip = FALSE,
  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    plotMap <- function(){
      ...
      obsConfirm <- shiny::observeEvent(input$confirmButton5, {
        #disable buttons temporarily
        shinyjs::disable("confirmButton5")
        ...
        future::future({
          ...
          shinyjs::reset("confirmButton5")
          shinyjs::enable("confirmButton5")
